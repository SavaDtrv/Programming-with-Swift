...
func depth(root: VisualComponent?) -> Int {
    ...
    for child in root.children {
        maxdepth = maxDepth(currentSubTreeDepth:maxdepth, nextSubTreeDepth:depth(child))
    }
...
func maxDepth(currentSubTreeDepth:Int, nextSubTreeDepth:Int) -> Int {
    if currentSubTreeDepth > nextSubTreeDepth {
        return currentSubTreeDepth
    } else {
        return nextSubTreeDepth
    }
}